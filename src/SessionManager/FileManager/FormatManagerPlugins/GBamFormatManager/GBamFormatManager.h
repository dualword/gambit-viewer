// ***************************************************************************
// GBamFormatManager.h (c) 2009 Derek Barnett
...
#ifndef G_BAMFORMATMANAGER_H
#define G_BAMFORMATMANAGER_H
...
class GBamFormatManager : public QObject, public GAbstractFormatManager {

    Q_OBJECT
    Q_INTERFACES(Gambit::FileIO::GAbstractFormatManager)

    public:
        GBamFormatManager(QObject* parent = 0);
        ~GBamFormatManager(void);
