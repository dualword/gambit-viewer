// ***************************************************************************
// GFastaReader.h (c) 2009 Derek Barnett
...
#ifndef G_FASTAREADER_H
#define G_FASTAREADER_H
...
class GFastaReader : public GAbstractFileReader {
    ...
    private:
        struct GFastaReaderPrivate;
        GFastaReaderPrivate* d;
};

} // namespace FileIO
} // namespace Gambit

#endif // G_FASTAREADER_H
