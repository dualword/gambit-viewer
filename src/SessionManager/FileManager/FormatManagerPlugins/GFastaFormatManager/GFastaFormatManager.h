// ***************************************************************************
// GFastaFormatManager.h (c) 2009 Derek Barnett
...
#ifndef G_FASTAFORMATMANAGER_H
#define G_FASTAFORMATMANAGER_H
...
class GFastaFormatManager : public QObject, public GAbstractFormatManager {

    Q_OBJECT
    Q_INTERFACES(Gambit::FileIO::GAbstractFormatManager)

    public:
        GFastaFormatManager(QObject* parent = 0);
        ~GFastaFormatManager(void);
